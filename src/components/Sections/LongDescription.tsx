...
const LongDescription = () => (
  <span className="text-zinc-500">
    ...
    website performance and speed. Additionally, I am excited about learning and
    incorporating new technologies into my development work, and I enjoy
    collaborating with teams to create outstanding web experiences.
  </span>
);
