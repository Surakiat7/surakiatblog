...
const Footer = () => {
  ...
  return (
    <main
      className={`px-8 py-8 ${bgColorClass} sm:max-w-xl md:max-w-full max-w-screen-xl`}
    >
      <div className="flex w-full justify-between pb-4">
        <div className="flex w-fit justify-start items-start">
          <div className="flex items-center gap-4">
            ...
            <p className={`font-normal whitespace-nowrap ${textColorClass}`}>
              Sed ut perspiciatis
            </p>
            <p className={`font-normal whitespace-nowrap ${textColorClass}`}>
              Eaque ipsa qua
      ...
      <div className="flex justify-between border-t border-zinc-300 lg:flex-row pt-4">
