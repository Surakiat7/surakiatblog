...
export const PostData: Post[] = [
  {
    id: 1,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-1.png`,
  ...
  {
    id: 2,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-2.png`,
    author: "Author: Surakiat",
    views: 47,
    createdAt: "2024-07-30T08:00:00Z",
  ...
  {
    id: 3,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-3.png`,
    author: "Author: Surakiat",
    views: 68,
    createdAt: "2024-07-30T08:00:00Z",
  ...
  {
    id: 4,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-4.png`,
    author: "Author: Surakiat",
    views: 26,
    createdAt: "2024-07-30T08:00:00Z",
    ...
    content: [
      ...
      {
        imagesrc: "https://swagger.io/docs/assets/img/swagger-ui.png",
      ...
      {
        imagesrc: "https://swagger.io/docs/assets/img/test-api.png",
  ...
  {
    id: 5,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-5.png`,
    author: "Author: Surakiat",
    views: 92,
    createdAt: "2024-07-30T08:00:00Z",
    ...
    content: [
      {
        imagesrc: "https://figma.com/images/figma-devtools.png",
      ...
      {
        imagesrc: "https://figma.com/images/figma-plugin.png",
      ...
      {
        imagesrc: "https://figma.com/images/figma-assets.png",
      ...
      {
        imagesrc: "https://figma.com/images/figma-designs.png",
      ...
      {
        imagesrc: "https://figma.com/images/figma-workflow.png",
  ...
  {
    id: 6,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-6.png`,
    author: "Author: Surakiat",
    views: 53,
    createdAt: "2024-07-30T08:00:00Z",
  ...
  {
    id: 7,
    imgUrl: `${process.env.NEXT_PUBLIC_IMGIX_DOMAIN}/Banner-Cover-7.png`,
    author: "Author: Surakiat",
    views: 71,
    createdAt: "2024-07-30T08:00:00Z",
    title:
